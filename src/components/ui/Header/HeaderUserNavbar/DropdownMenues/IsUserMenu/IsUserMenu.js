...
const IsUserMenu = ({
    ...
    return(
        <div className="w-[286px] min-h-[392px] absolute right-0 top-[51px] rounded-[18px] shadow-dropdown-menu border-dropdown border-[1px] p-[20px] flex flex-col gap-[20px]">
            <p
