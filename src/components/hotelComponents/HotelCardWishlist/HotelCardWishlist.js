...
const HotelCardWishlist = ({ data, index }) => {
  const hotelPrice = parseInt(data?.cheapest_room_price)
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute top-[40px] w-[195px] h-[38px] bg-green rounded-r-full flex items-center pl-[10px]">
