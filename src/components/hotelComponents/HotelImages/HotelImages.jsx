      ...
      <div className="flex items-center justify-center w-[490px]">
        {isLoading ? (
          ...
          <img
            ...
            src={data?.results?.[0]?.housing_images[0]?.image}
            alt="hotelImg"
          />
        )}
      </div>
      <div className="">
        <div className="flex justify-between gap-[10px] mb-[10px]">
          <img
            ...
            src={data?.results?.[0]?.housing_images[1]?.image}
            alt="hotelImg2"
          />
          <img
            className="w-[365px] h-[245px] rounded-tr-2xl"
            src={data?.results?.[0]?.housing_images[2]?.image}
            alt="hotelImg2"
          />
        </div>
        <div className="flex gap-[10px] relative">
          <img
            className="w-[365px] h-[245px]"
            src={data?.results?.[0]?.housing_images[3]?.image}
            alt="hotelImg2"
          />
          <img
            className="w-[365px] h-[245px] rounded-br-2xl"
            src={data?.results?.[0]?.housing_images[4]?.image}
            alt="hotelImg2"
          />
