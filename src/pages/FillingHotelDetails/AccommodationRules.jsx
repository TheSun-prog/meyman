...
function AccommodationRules(props) {
    ...
    return (
        <div className="mx-auto w-[1240px]">
            ...
            <RadioGroup
                ...
                onChange={(event) => setSelectedOption11(event.target.value)}
            >
            ...
            {selectedOption11 === 'yes' && (
                <div>
                    ...
                    <RadioGroup
                        ...
                        onChange={(event) => setSelectedOption12(event.target.value)}
                    >
                        <FormControlLabel value="yes" control={<Radio sx={{
                            color: "black",
                            '&.Mui-checked': {
